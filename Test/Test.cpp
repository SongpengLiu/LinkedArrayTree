...
template <class T>
void RemainderSkipListTest(unordered_set<T> dataSet,unsigned int maxValue){
    string message = "--------------remainder skip list--------------";
    TestLog::appendLog(message);
    ...
    RemainderSkipList<unsigned int>* skipList = new RemainderSkipList<unsigned int>(maxValue);
...
int main(){
    ...
    unsigned int maxValue=11000000;
    ...
    RemainderSkipListTest(randomSet,maxValue);
    BTreeTest(randomSet);
